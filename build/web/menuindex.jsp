    ...
    <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top" style="background: #fff;"> 
        ...
        <div class="container"> 
            ...
            <div class="navbar-collapse collapse justify-content-center" id="navbarDefault"> 
                <!-- Links do Menu Nav -->
                <ul class="navbar-nav">
                    <li class="nav-item"><a class="nav-link text-center active" href="index.jsp">Pagina Inicial</a></li>
                    <li class="nav-item"><a class="nav-link text-center" href="sobre.jsp">Sobre</a></li>
                ...
                <div class="modal-body"> <!-- Corpo do modal -->
                    ...
                    <form action="ValidarForm" method="POST" id="formCadastro" name="formCadastro">
                        ...
                        <div class="wrap-input">
                            <input class="input-login" type="text" id="email" name="txtCadastroEmail" placeholder="Email" required>
                            <span class="focus-input-login"></span><span class="symbol-input-login"><i class="fa fa-envelope" aria-hidden="true"></i></span>
                        </div>
                        <div class="wrap-input">
                            <input class="input-login" type="password" name="password" id="password" placeholder="Senha" required>
                            <span class="focus-input-login"></span><span class="symbol-input-login"><i class="fa fa-lock" aria-hidden="true"></i></span>
                        </div>
                        <div class="wrap-input">
                            <input class="input-login" type="password" name="conf_password" id="conf_password" placeholder="Confirmar senha" required>
                            <span class="focus-input-login"></span><span class="symbol-input-login"> <i class="fa fa-lock" aria-hidden="true"></i></span>
                        </div>  
                        <div class="container-form-btn">
                            <input type="hidden" name="acao" value="cadastrarAcesso">
                            <button class="login-form-btn" type="button" onClick="validar()">Cadastre-se</button>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body"><!-- Corpo do Modal -->
                    ...
                    <form name="formLogin" action="ValidarAcesso" method="POST">
                        <span class="form-title fa fa-user-circle-o" style="padding-top: 2%; color: #21d192;"></span>
                        <div class="wrap-input">
