    ...
    <body>
                    ...
                    <div class="col-md-12 col-lg-4">
                        <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item color-b" aria-current="page"> Exclusão de Usuários </li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="container" id="to-breadcrumb">
            <div class="jumbotron-alert text-center">
                ...
                <p class="lead">Ao continuar com essa operação, você estará apagando todos os dados do usuário <strong>${usuario.nome}</strong> permanentemente!</p>
                <hr class="my-4">
