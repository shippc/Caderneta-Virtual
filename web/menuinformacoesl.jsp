        ...
        <div class="container"> 
            ...
            <div class="navbar-collapse collapse justify-content-center" id="navbarDefault"> 
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link text-center" href="sistemasl.jsp">Sistemas</a></li>
                    <li class="nav-item"><a class="nav-link text-center active" href="informacoesl.jsp">Informações</a></li>
